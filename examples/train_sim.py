...
def main(variant):
    ...
    if variant.algorithm == 'pixel_sac':
        ...
        agent = PixelSACLearner(variant.seed, sample_obs, sample_action, kl_coeff=variant.kl_coeff, decay_kl=variant.decay_kl, chunk_len=variant.query_freq, distill_action_dim=distill_action_dim, distill_hidden_dim=variant.distill_hidden_dim, **kwargs)
