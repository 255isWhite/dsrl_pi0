...
ablations=(
  "label=dsrl_td3,task_id=1,task_suite=libero_10,max_timesteps=500"
  "label=dsrl_td3,task_id=2,task_suite=libero_10,max_timesteps=500"
  "label=dsrl_td3,task_id=4,task_suite=libero_10,max_timesteps=500"
  "label=dsrl_td3,task_id=5,task_suite=libero_10,max_timesteps=500"

  "label=dsrl_td3,task_id=1,task_suite=libero_10,max_timesteps=500,kl_coeff=1.0"
  "label=dsrl_td3,task_id=2,task_suite=libero_10,max_timesteps=500,kl_coeff=1.0"
  "label=dsrl_td3,task_id=4,task_suite=libero_10,max_timesteps=500,kl_coeff=1.0"
  "label=dsrl_td3,task_id=5,task_suite=libero_10,max_timesteps=500,kl_coeff=1.0"
)
