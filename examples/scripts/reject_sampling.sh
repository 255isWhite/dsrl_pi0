...
ablations=(
  "label=reject_toy,task_id=0"
  "label=reject_toy,task_id=1"
  "label=reject_toy,task_id=2"
  "label=reject_toy,task_id=3"
  "label=reject_toy,task_id=4"
  "label=reject_toy,task_id=5"
  "label=reject_toy,task_id=6"
  "label=reject_toy,task_id=7"

  "label=reject_toy,task_id=8"
  "label=reject_toy,task_id=9"
  "label=reject_toy,task_id=4,task_suite=libero_spatial,max_timesteps=400"
  "label=reject_toy,task_id=5,task_suite=libero_object,max_timesteps=400"
  "label=reject_toy,task_id=0,task_suite=libero_goal,max_timesteps=400"
  "label=reject_toy,task_id=1,task_suite=libero_goal,max_timesteps=400"
  "label=reject_toy,task_id=2,task_suite=libero_goal,max_timesteps=400"
  "label=reject_toy,task_id=3,task_suite=libero_goal,max_timesteps=400"
  
  "label=reject_toy,task_id=4,task_suite=libero_goal,max_timesteps=400"
  "label=reject_toy,task_id=5,task_suite=libero_goal,max_timesteps=400"
)
