...
from jaxrl2.agents.pixel_sac_residual.actor_updater import update_actor, update_res_actor
from jaxrl2.agents.pixel_sac_residual.critic_updater import update_critic, update_critic_wo_actor, update_clean_critic
from jaxrl2.agents.pixel_sac_residual.temperature_updater import update_temperature
from jaxrl2.agents.pixel_sac_residual.temperature import Temperature
...
def _update_jit(
    ...
    new_clean_critic, clean_critic_info = update_clean_critic(
        key, critic, clean_critic, res_actor, batch, discount, res_coeff, res_prob, critic_reduction=critic_reduction
    )
    ...
    return rng, new_actor, new_critic, new_target_critic_params, new_res_actor, new_clean_critic, new_temp, {
        **critic_info,
        **actor_info,
        **alpha_info
    }, {
...
def _update_jit_wo_actor(
    ...
    return rng, new_critic, new_target_critic_params, new_res_actor, new_clean_critic, {
        **critic_info,
    }, {
        **clean_critic_info,
        **res_actor_info
